...
const int totalInterludeMode = 4;
const int maxColorWipe = 12;
const int totalColorChase = 1;
const int rainbowSteps = 450;
const int waveTimes = 8;

const byte SCANNERINTERVAL = 20; //default 80
const byte WIPEINTERVAL = 6;
const byte CHASEINTERVAL = 6;
const byte THEATERINTERVAL = 25;
const byte RAINBOWINTERVAL = 7;
const byte WAVEINTERVAL = 10;

//powered by 1 AAA battery and 5V step-up converter
//current draw is about 200mA

const byte BRI         = 20;
const byte BRI_SCANNER = 60;
const byte BRI_THEATER = 32;
const byte BRI_RAINBOW = 24;
const byte BRI_WIPE = 16;
const byte BRI_WAVE = 24;
const byte BRI_CHASE = 24;
const byte CHASEDOTS = 4;
...
//const byte pinkArrayRed[PINKSIZE] =   { 244, 244, 236,  13, 238,  76};
//const byte pinkArrayGreen[PINKSIZE] = { 123, 237,  32, 165,  44, 169};
//const byte pinkArrayBlue[PINKSIZE] =  {  48,  63, 135, 223,  52,  93};

const byte pinkArrayRed[PINKSIZE] =   { 0xf4, 0xf4, 0xec, 0x0d, 0xee, 0x4c};
const byte pinkArrayGreen[PINKSIZE] = { 0x7b, 0xed, 0x20, 0xa5, 0x2c, 0xa9};
const byte pinkArrayBlue[PINKSIZE] =  { 0x30, 0x3f, 0x87, 0xdf, 0x34, 0x5d};

//const byte pinkArrayRed[PINKSIZE] =   { 255, 0, 0,  255, 0,  255};
//const byte pinkArrayGreen[PINKSIZE] = { 0, 255,  0, 255,  255, 0};
//const byte pinkArrayBlue[PINKSIZE] =  {  0,  0, 255, 0,  255,  255};
...
class NeoPatterns : public Adafruit_NeoPixel
{
    ...
    void OnCompleteLocal() {
            ...
            switch(ActivePattern)
            {
                ...
                case COLOR_WIPE:
                    pinkCount++;
                    if(pinkCount==PINKSIZE) {
                      pinkCount = 0;
                    }   
                    Color2 = Color1;
                    //Color1 = Wheel(random(255));
                    Color1 = Color(pinkArrayRed[pinkCount],pinkArrayGreen[pinkCount],pinkArrayBlue[pinkCount]);
                    //Interval = 20000;
      ...
      */
      ...
      case 1:
        if (strip.ActivePattern == COLOR_WIPE) {
          ...
          strip.ColorWipe(strip.Color(pinkArrayRed[0],pinkArrayGreen[0],pinkArrayBlue[0]), WIPEINTERVAL);
          pinkCount = 0;
        }
      break;    
      ...
      case 0:
        ...
        for (int x=0; x<PINKSIZE; x++) {
          for (int i=0; i<totalColorChase; i++) {
            colorChase(strip.Color(pinkArrayRed[x],pinkArrayGreen[x],pinkArrayBlue[x]), CHASEDOTS, CHASEINTERVAL);
            colorChaseReverse(strip.Color(pinkArrayRed[x],pinkArrayGreen[x],pinkArrayBlue[x]), CHASEDOTS, CHASEINTERVAL);    
          } 
        }
        interludeMode++;
        enableInterlude = false;
